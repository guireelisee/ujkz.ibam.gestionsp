...
<li class="breadcrumb-item"><a href="{{ route('filiere.index') }}">Disponibles</a></li>
@endsection
            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="card-header-right">
                        <a href="{{ route('filiere.create') }}" type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Ajouter</a>
                    </div>
                </div>
                             ...
                             <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <form action="{{ route('filiere.destroy', $filiere->idFiliere)}}" method="POST">
                                                    <a class="btn btn-alternate" href="{{ route('filiere.edit',$filiere->idFiliere) }}"><i class="fas fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
