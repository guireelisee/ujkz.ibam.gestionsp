...
<li class="breadcrumb-item"><a href="{{ route('types.store') }}">Enregistrement</a></li>
@endsection
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form class="needs-validation" action="{{ route('titres.store') }}" method="post" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Intitulé</label>
                                <input name="titre" type="text" class="form-control" placeholder="Entrez un titre" required>
