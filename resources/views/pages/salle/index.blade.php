...
<li class="breadcrumb-item"><a href="{{ route('salle.index') }}">Disponibles</a></li>
@endsection
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <form action="{{ route('salle.destroy', $salle->idSalle)}}" method="POST">
                                                    <a class="btn btn-alternate" href="{{ route('salle.edit',$salle->idSalle) }}"><i class="fas fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
