    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form class="needs-validation" action="{{ route('types.store') }}" method="post" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Intitulé</label>
                                <input name="type" type="text" class="form-control" placeholder="Entrez un type" required>
